  ...
  return (
    <div style={{ height: "100vh", width: "100%", overflow: "hidden", background: "#F7F8F9" }}>
      <div className="tb-shell" style={{ display: "grid", gridTemplateColumns: "264px 1fr", height: "100vh" }}>
        {/* Sidebar — skjules på mobil (draweren er lukket som standard). */}
        <div className="tb-hide-mobile" style={{ background: "#181818", padding: "20px 18px" }}>
        ...
        <div>
          ...
          <div className="tb-pad" style={{ padding: "32px 28px" }}>
            {bar(220, 28)}
            {bar(320, 14, 10)}
